...
if (!process.env.PINATA_API_KEY || !process.env.PINATA_SECRET_API_KEY) {
  throw new Error('Missing Pinata environment variables: PINATA_API_KEY or PINATA_SECRET_API_KEY');
}
if (!process.env.ETH_NODE_URL) {
  throw new Error('Missing ETH_NODE_URL environment variable');
}
...
export const pinata = new PinataClient(process.env.PINATA_API_KEY, process.env.PINATA_SECRET_API_KEY);

const providerUrl = process.env.ETH_NODE_URL;
...
const contractABI = [
  ...
  },
  {
    ...
    "stateMutability": "view", // Fixed from "viewwartime","view"
    "type": "function"
  },
  {
    "inputs": [
  ...
  },
  {
    ...
    "name": "submitRegistrationRequest",
    "outputs": [],
    "stateMutability": "nonpayable",
    "type": "function"
  },
